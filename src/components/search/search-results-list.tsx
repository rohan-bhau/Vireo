      ...
      <table className="w-full text-left" style={{ tableLayout: "fixed" }}>
        <thead>
          <tr className="border-b border-[#DFE1E6] text-[11px] font-semibold uppercase tracking-wider text-[#737686]">
            ...
            <Th sortable field="taskKey" onClick={handleSort} width={colWidths.taskKey} onResize={(e) => initResize("taskKey", e)}><SortIcon field="taskKey" sortField={sortField} sortDir={sortDir} />Key</Th>
            <Th sortable field="title" onClick={handleSort} width={colWidths.title} onResize={(e) => initResize("title", e)}><SortIcon field="title" sortField={sortField} sortDir={sortDir} />Summary</Th>
            <Th sortable field="status" onClick={handleSort} width={colWidths.status} onResize={(e) => initResize("status", e)}><SortIcon field="status" sortField={sortField} sortDir={sortDir} />Status</Th>
            <Th sortable field="priority" onClick={handleSort} width={colWidths.priority} onResize={(e) => initResize("priority", e)}><SortIcon field="priority" sortField={sortField} sortDir={sortDir} />Priority</Th>
            <Th sortable field="assignee" onClick={handleSort} width={colWidths.assignee} onResize={(e) => initResize("assignee", e)}><SortIcon field="assignee" sortField={sortField} sortDir={sortDir} />Assignee</Th>
            <Th sortable field="updatedAt" onClick={handleSort} width={colWidths.updatedAt} onResize={(e) => initResize("updatedAt", e)}><SortIcon field="updatedAt" sortField={sortField} sortDir={sortDir} />Updated</Th>
          </tr>
        </thead>
