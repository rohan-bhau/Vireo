  ...
  return (
    <div className="flex items-center justify-between px-1">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-base font-semibold text-[#121C28]">{board.name}</h1>
      ...
      <div ref={ref} className="relative">
        <button
          ...
          className="rounded-[3px] p-2 text-[#737686] hover:bg-[#F1F2F6] transition-colors"
          title="Board menu"
        >
        ...
        {menuOpen && (
          <div className="absolute right-0 top-full mt-1 w-48 rounded-[3px] bg-white shadow-modal border border-[#DFE1E6] z-50 py-1">
            <button
              onClick={() => { onOpenConfig(); setMenuOpen(false); }}
              className="flex w-full items-center gap-2 px-3 py-2 text-sm text-[#121C28] hover:bg-[#F1F2F6] transition-colors"
            >
