...
export default function AuditLogPage() {
  ...
  const canViewAuditLog = hasFeature(subscription?.plan, "ssoAuditLogs");
    ...
    return (
      <div className="flex flex-1 items-center justify-center p-6">
        <div className="max-w-md rounded-2xl border border-[#C3C6D7]/30 bg-surface p-8 text-center">
          ...
          <h3 className="mt-4 text-lg font-semibold text-text">Available on Enterprise</h3>
          <p className="mt-1.5 text-sm text-text-secondary">
            Audit logs and SSO are part of the Enterprise plan. Contact sales to upgrade.
          </p>
          <Link
